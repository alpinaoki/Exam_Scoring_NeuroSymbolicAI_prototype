            ...
            { inlineData: { mimeType: 'image/jpeg', data: base64Image } },
            {
              text: `
                ...
                2. 命題（proposition）ノード（純粋な数式の抽出）:
                   ...
                   - 数式は必ずLaTeX形式（$記号の囲みは不要、数式コマンドのみ）で記述してください。
                ...
                {
                  "nodes": [
                    { "id": "p1", "label": "x + y = 3", "type": "proposition" },
                    { "id": "p2", "label": "x - y = 1", "type": "proposition" },
                    { "id": "i1", "label": "p1とp2の辺々を足す", "type": "inference" },
                    { "id": "p3", "label": "2x = 4", "type": "proposition" }
                  ],
                  "edges": [
                    { "from": "p1", "to": "i1" },
                    { "from": "p2", "to": "i1" },
